        ...
        return (
            <Card title="متقاضی جدید">
                ...
                <div className="row">
                    ...
                    <Radio label="جنسیت" className="col-md-4" ref="gender" defaultValue={item.tavanaei_status} data={gender} />
                ...
                <div className="row">
                    ...
                    <Radio label="وضعیت سکونت" className="col-md-4" ref="residence" defaultValue={item.residence_status} data={residence} />
                ...
                <div className="row">
                    ...
                    <Radio label="توانایی انجام کار دارد؟" className="col-md-4" ref="tavanaei" defaultValue={item.tavanaei_status} data={need} />
                    <Radio label="نیاز مادی دارد؟" className="col-md-4" ref="need_materials" defaultValue={item.need_materials_id} data={need} />
                    <Radio label="نیاز به مشاور دارد؟" className="col-md-4" ref="need_moshaver" defaultValue={item.form_code} data={need} />
                    <Radio label="نیاز فرهنگی دارد؟" className="col-md-4" ref="need_farhangi" defaultValue={item.form_code} data={need} />
                    <Radio label="نیاز به شغل دارد؟" className="col-md-4" ref="need_job" defaultValue={item.form_code} data={need} />
                    <Radio label="نیاز به خدمات پزشکی دارد؟" className="col-md-4" ref="need_doktor" defaultValue={item.form_code} data={need} />
                    <Radio label="نیاز به حمایت تحصیلی دارد؟" className="col-md-4" ref="need_amozesh" defaultValue={item.form_code} data={need} />
                    <Radio label="نیاز به بسترسازی معنوی دارد؟" className="col-md-4" ref="need_manavi" defaultValue={item.form_code} data={need} />
